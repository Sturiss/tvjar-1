...
public class Zxzj extends Spider {
    ...
    private static final String siteHost = "zxzj.vip";
    ...
    public String homeContent(boolean filter) {
        try {
            Document doc = Jsoup.parse(OkHttpUtil.string("https://zxzj.vip", getHeaders(siteUrl)));
    ...
    public String detailContent(List<String> ids) {
        try {
            String url = "https://zxzj.vip/detail/" + ids.get(0) + ".html";
    ...
    */
    ...
    public String playerContent(String flag, String id, List<String> vipFlags) {
        try {
            ...
            String url = "https://zxzj.vip/video/" + id + ".html";
